...
class RewardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post rewards_url, params: { reward: { description: @reward.description, pic: @reward.pic, points: @reward.points, title: @reward.title } }
    end
  ...
  test "should update reward" do
    patch reward_url(@reward), params: { reward: { description: @reward.description, pic: @reward.pic, points: @reward.points, title: @reward.title } }
